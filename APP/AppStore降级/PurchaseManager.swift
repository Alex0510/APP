...
class PurchaseManager {
    ...
    func purchaseApp(
        ...
        do {
            ...
            // 修复：使用 StoreRequestError 而不是 StoreError
            if let se = error as? StoreRequestError, se == .userInteractionRequired {
    ...
    func checkAppOwnership(
        ...
        } catch let storeError as StoreRequestError { // 修复：使用 StoreRequestError
            // 特殊处理StoreRequestError类型的错误
