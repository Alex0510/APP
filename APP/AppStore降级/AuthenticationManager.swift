...
class AuthenticationManager {
    ...
    func authenticate(email: String, password: String, mfa: String? = nil) async throws -> Account {
        print("🔐 [AuthenticationManager] 开始认证流程")
        print("📧 [AuthenticationManager] Apple ID: \(email)")
        ...
        while retryCount < maxRetries {
            do {
                ...
                print("🔐 [AuthenticationManager] 认证成功，地区代码: \(countryCode), storeFront: \(storeFront)")
